# williamify
revolutionary new technology that turns any image into william
...
Install the latest version in [releases](https://github.com/Spu7Nix/williamify/releases). Unzip and run the .exe file inside!
